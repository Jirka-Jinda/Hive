    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
            <div className="bg-gray-900 border border-gray-700/60 rounded-xl shadow-2xl w-full max-w-lg mx-4 flex flex-col max-h-[80vh]">
                ...
                {done && (
                    <p className="px-4 pb-2 text-xs text-amber-400 shrink-0">
                    ...
                    <div className="flex gap-2">
                        ...
                        {missingCount > 0 && !done && (
                            <button
                                ...
                                disabled={installing}
                                className="text-xs px-4 py-1.5 rounded border border-amber-500 bg-amber-600/80 hover:bg-amber-500 text-white font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                            >
